...
LweSample *TableS0[8]; 
LweSample *TableS1[8]; //Point array
                          ...
                          TFheGateBootstrappingParameterSet *params, TFheGateBootstrappingSecretKeySet *key)
{
    ...
    bootsSymEncrypt(u.word + 0, 0, key); 
    for (int i = 1; i < 32; i++)
    {
...
int main()
{
    ...
    cout << " encrypt unsigned int ZUC_d[16]" << endl;
    ...
    cout << "the time of homomorphic evaluation of ZUC is:" << totaltime << "s！" << endl;
